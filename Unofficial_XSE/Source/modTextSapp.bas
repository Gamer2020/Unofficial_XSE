...
Dim i As Long
    ...
    sSapp2AscJap(&H32) = "le"
    sSapp2AscJap(&H33) = "lo"
    sSapp2AscJap(&H34) = "lya"
    sSapp2AscJap(&H35) = "lyu"
    sSapp2AscJap(&H36) = "lyo"
    sSapp2AscJap(&H37) = "ga"
    sSapp2AscJap(&H38) = "gi"
    sSapp2AscJap(&H39) = "gu"
    sSapp2AscJap(&H3A) = "ge"
    ...
    sSapp2AscJap(&H82) = "LE"
    sSapp2AscJap(&H83) = "LO"
    sSapp2AscJap(&H84) = "LYA"
    sSapp2AscJap(&H85) = "LYU"
    sSapp2AscJap(&H86) = "LYO"
    sSapp2AscJap(&H87) = "GA"
    sSapp2AscJap(&H88) = "GI"
    sSapp2AscJap(&H89) = "GU"
    sSapp2AscJap(&H8A) = "GE"
    ...
    sSapp2AscJap(&HBB) = "*A" ' "A"
    sSapp2AscJap(&HBC) = "*B" ' "B"
    sSapp2AscJap(&HBD) = "*C" ' "C"
    sSapp2AscJap(&HBE) = "*D" ' "D"
    sSapp2AscJap(&HBF) = "*E" ' "E"
    sSapp2AscJap(&HC0) = "*F" ' "F"
    sSapp2AscJap(&HC1) = "*G" ' "G"
    sSapp2AscJap(&HC2) = "*H" ' "H"
    sSapp2AscJap(&HC3) = "*I" ' "I"
    sSapp2AscJap(&HC4) = "*J" ' "J"
    sSapp2AscJap(&HC5) = "*K" ' "K"
    sSapp2AscJap(&HC6) = "*L" ' "L"
    sSapp2AscJap(&HC7) = "*M" ' "M"
    sSapp2AscJap(&HC8) = "*N" ' "N"
    sSapp2AscJap(&HC9) = "*O" ' "O"
    sSapp2AscJap(&HCA) = "*P" ' "P"
    sSapp2AscJap(&HCB) = "*Q" ' "Q"
    sSapp2AscJap(&HCC) = "*R" ' "R"
    sSapp2AscJap(&HCD) = "*S" ' "S"
    sSapp2AscJap(&HCE) = "*T" ' "T"
    sSapp2AscJap(&HCF) = "*U" ' "U"
    sSapp2AscJap(&HD0) = "*V" ' "V"
    sSapp2AscJap(&HD1) = "*W" ' "W"
    sSapp2AscJap(&HD2) = "*X" ' "X"
    sSapp2AscJap(&HD3) = "*Y" ' "Y"
    sSapp2AscJap(&HD4) = "*Z" ' "Z"
    sSapp2AscJap(&HD5) = "*a" ' "a"
    sSapp2AscJap(&HD6) = "*b" ' "b"
    sSapp2AscJap(&HD7) = "*c" ' "c"
    sSapp2AscJap(&HD8) = "*d" ' "d"
    sSapp2AscJap(&HD9) = "*e" ' "e"
    sSapp2AscJap(&HDA) = "*f" ' "f"
    sSapp2AscJap(&HDB) = "*g" ' "g"
    sSapp2AscJap(&HDC) = "*h" ' "h"
    sSapp2AscJap(&HDD) = "*i" ' "i"
    sSapp2AscJap(&HDE) = "*j" ' "j"
    sSapp2AscJap(&HDF) = "*k" ' "k"
    sSapp2AscJap(&HE0) = "*l" ' "l"
    sSapp2AscJap(&HE1) = "*m" ' "m"
    sSapp2AscJap(&HE2) = "*n" ' "n"
    sSapp2AscJap(&HE3) = "*o" ' "o"
    sSapp2AscJap(&HE4) = "*p" ' "p"
    sSapp2AscJap(&HE5) = "*q" ' "q"
    sSapp2AscJap(&HE6) = "*r" ' "r"
    sSapp2AscJap(&HE7) = "*s" ' "s"
    sSapp2AscJap(&HE8) = "*t" ' "t"
    sSapp2AscJap(&HE9) = "*u" ' "u"
    sSapp2AscJap(&HEA) = "*v" ' "v"
    sSapp2AscJap(&HEB) = "*w" ' "w"
    sSapp2AscJap(&HEC) = "*x" ' "x"
    sSapp2AscJap(&HED) = "*y" ' "y"
    sSapp2AscJap(&HEE) = "*z" ' "z"
